...
Once your models are trained, launch the Streamlit dashboard from the root directory:
...
## Features
- **Exploratory Data Analysis (EDA):** Complete Data & EDA tab featuring geographical Mapbox visualizations, correlation heatmaps, feature importance charts, and raw data viewers.
...
- **Global Dashboard:** Instantly visualizes the Weather, Rainfall, and AQI for a selected city and year on a single view.
...
[![Email](https://img.shields.io/badge/Email-Expert.aliasif%40gmail.com-blue)](mailto:Expert.aliasif@gmail.com)  
[![LinkedIn](https://img.shields.io/badge/LinkedIn-expert--ali--asif-blue?logo=linkedin)](https://www.linkedin.com/in/expert-ali-asif/)  
[![GitHub](https://img.shields.io/badge/GitHub-expert--aliasif-black?logo=github)](https://github.com/expert-aliasif)
